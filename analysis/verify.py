...
def main():
    ...
    payload={'runs':records,'exact_baseline_reproduced':True,'local_quantile_oracle_tests':True,'selection_invariant_to_calibration_and_test_targets':True,'public_dataset_sha256':hashlib.sha256((REPO/'data/df_final.csv.gz').read_bytes()).hexdigest()}
